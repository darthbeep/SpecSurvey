...
function frExNar() {
	...
	frHTML += "<br><br>";
	frHTML += "We asked incoming students if they expected to attend an Ivy League University, MIT, or Stanford when they graduated from Stuyvesant. 65.3 percent of students agreed or strongly agreed that they might. For reference, 17.4 percent of the graduating seniors we surveyed are attending an Ivy League University this coming school year, through Naviance data shows that this number is closer to 10 or 15 percent on a grade-wide level.";
	frHTML += "<br><br>";
	frHTML += "Males and females showed no notable difference in their expectations for this level of college education, but white students and those coming from upper-class families were much more likely to expect a college education at one of these schools, with a remarkable 85.7 percent of upper class students agreeing they might attend. Students with parents who had a post-college education were also more likely to expect attendance at one of these elite colleges.";
	frHTML += "<br><br>";
